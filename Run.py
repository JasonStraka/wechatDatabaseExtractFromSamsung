...
OUTER_PASS_LENGTH = 4 # control the outer cycle number, more cycle means more context change overhead and more exchange rate and less useless computation in last cycle
PASS_CHARS_Variety = 16 # 0-9,a-f

PBKDF2_ITER = 4000 # sqlcipherv2 standard is 4000
# PBKDF2_ITER = 64000 # sqlcipherv2 standard is 4000
PAGE_SIZE = 1024 # value varies on application specification, we assume db is encrypted by each page, of 1024 byte
# PAGE_SIZE = 4096 # value varies on application specification, we assume db is encrypted by each page, of 1024 byte


Encrypted_DB_PATH="EnMicroMsg.db"
