...
class AmalgationLibSQLCipherBuilder(build_ext):
    ...
    def build_extension(self, ext):
        ...
        if sys.platform == "win32":
            ...
            ext.extra_link_args.append("libcrypto64MD.lib")
            ext.extra_link_args.append("libssl64MD.lib")
